...
@section('title','Thêm nhật ký phun thuốc')
@section('content')
    <main role="main" class="main-content">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h2 class="page-title">Thêm mới nhật ký phun thuốc</h2>
                    <p class="text-muted">Nhật ký phun thuốc được dùng cho việc cập nhật tình hình phun thuốc trên cây trồng</p>
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card shadow mb-4">
                                <div class="card-header">
                                    <strong class="card-title">Nhật ký phun thuốc</strong>
                                </div>
                                <div class="card-body">
