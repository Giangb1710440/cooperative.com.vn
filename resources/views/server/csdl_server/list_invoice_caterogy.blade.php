                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-md-5 my-4">
                            <h2 class="h4 mb-1  text-center">THÊM MỚI LOẠI HÓA ĐƠN</h2>
                            <p class="mb-3 text-center">Chức năng được tích hợp ngay tại trang quản lí loại hóa đơn, thuận tiện cho người dùng thao tác</p>
                        ...
                        <div class="col-md-7 my-4">
                            <h2 class="h4 mb-1 text-center">DANH SÁCH LOẠI HÓA ĐƠN</h2>
