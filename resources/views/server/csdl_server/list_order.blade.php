                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                ...
                                                @foreach($order as $orders)
                                                    <tr class="accordion-toggle collapsed" id="c-2474" data-toggle="collapse" data-parent="#c-2474" href="#collap-{{$orders->id}}">
                                                        ...
                                                        <td>
                                                            @php($user = DB::table('users')->where('id','=',$orders->id_user)->get())
                                                                        ...
                                                                        <div class="card shadow">
                                                                            <div class="card-body p-5">
                                                                                ...
                                                                                <table class="table table-borderless table-striped">
                                                                                    ...
                                                                                    <?php
                                                                                        $key=0;
                                                                                        $detail_order = DB::table('order_details')->where('id_order','=',$orders->id)->get();
                                                                                    ?>
                                                                                    @foreach($detail_order as $detail_orders)
                                                                                        @php($product = DB::table('products')->where('id','=',$detail_orders->id_product)->get())
                                                                                        <tr>
                                                                                            <th scope="row">{{++$key}}</th>
                                                                                            <td width="130px">
                                    ...
                                    <div class="card shadow">
                                        <div class="card-body">
                                            ...
                                            <table class="table datatables" id="dataTable-2">
                                                ...
                                                <tbody>
                                                @php($order = DB::table('orders')->where('status_order','=',0)->get())
                                                @foreach($order as $orders)
                                                    <tr class="accordion-toggle collapsed" id="c-2474" data-toggle="collapse" data-parent="#c-2474" href="#collap-{{$orders->id}}">
                                                        <td>
                                                            <i class="fas fa-paperclip"></i>
                                    ...
                                    <div class="card shadow">
                                        <div class="card-body">
                                            ...
                                            <table class="table datatables" id="dataTable-3">
                                                ...
                                                <tbody>
                                                @php($order = DB::table('orders')->where('status_order','=',1)->get())
                                                @foreach($order as $orders)
                                                        <tr class="accordion-toggle collapsed" id="c-2474" data-toggle="collapse" data-parent="#c-2474" href="#collap-{{$orders->id}}">
                                                            <td>
                                                                <i class="fas fa-paperclip"></i>
                                    ...
                                    <div class="card shadow">
                                        <div class="card-body">
                                            ...
                                            <table class="table datatables" id="dataTable-4">
                                                ...
                                                <tbody>
                                                @php($order = DB::table('orders')->where('status_order','=',2)->get())
                                                @foreach($order as $orders)
                                                    <tr class="accordion-toggle collapsed" id="c-2474" data-toggle="collapse" data-parent="#c-2474" href="#collap-{{$orders->id}}">
                                                            <td>
                                                                <i class="fas fa-paperclip"></i>
