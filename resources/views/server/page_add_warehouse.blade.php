    ...
    <main role="main" class="main-content">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h2 class="page-title text-center">Khởi tạo tồn kho</h2>
                    <p class="text-muted text-center">Kho hàng sau khi được khỏi tạo có thể cung cấp các chức năng quản lý kho hàng cho người quản trị</p>
                    <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" enctype="multipart/form-data" action="{{route('post_detail_warehouse')}}" method="post">
                                        ...
                                        <a style="margin-left: 10px" class="btn btn-primary" href="{{route('admin_home')}}"><i class="fas fa-home"></i> Trang chủ </a>
                                    </form>
                                </div> <!-- /.card-body -->
                            </div> <!-- /.card -->
                        </div> <!-- /.col -->
